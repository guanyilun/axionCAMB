...
!!!!Timing Stuff
    ...
    open(unit=66,file="wax_table.dat",status='replace')

    write(66,'("#",a5,*(a24))') 'i', 'log(a)', 'wax', 'cs2', 'rhoax'
    do i=1,ntable,1
       write(66,'(i6,4f24.16)') i, Params%loga_table(i), Params%wax_table(i), Params%cs2_table(i), Params%grhoax_table(i)
    enddo
